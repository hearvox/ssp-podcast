...
function ssppod_feed_tags_url_callback( $args ) {
    ...
    <p class="description"><?php _e( 'XML template file with tags that go above and below episode items', 'ssppod' ); ?> (<a href="<?php echo SSPPOD_URL; ?>xml/template-tags.xml"><?php _e( 'default file', 'ssppod' ); ?></a>).</p>
    <?php
}
